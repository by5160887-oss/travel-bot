...
- בנושאים רגישים, לרבות משפט, בטיחות, בריאות, נגישות, חירום, אלימות, אובדן, אפליה, מצוקה או סיכון לאדם, שמור על טון רציני, ברור ואמפתי. אין להשתמש בהומור, משחק מילים או קריצה תיירותית שעלולים להקטין את הסיכון.
